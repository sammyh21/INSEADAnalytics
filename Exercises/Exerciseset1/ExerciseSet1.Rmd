...
**Your Answers here:**
<br> 1. It is done here: source("dataSet1.R")
<br> 2. 597, 0.148, 2.39
<br>
<br>
...
**Your Answers here:**
<br> 1. dim(transposedData)
<br> 2. > portfolio = apply(transposedData,2,mean)
<br>    > names(portfolio) <- rownames(transposedData)
